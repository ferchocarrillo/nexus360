...
@section('content')
                            ...
                            <div class="form-group col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-lg-2" id="div_not_show">
                                        ...
                                        <br>
                                        <input type="radio" name="not_show" id="not_show_yes" onclick="showRadio(id)"
                                            value="yes" required="required"><label>Yes</label>
                                        <input type="radio" name="not_show" id="not_show_no" onclick="showRadio(id)"
                                            value="no"><label>No</label><br>
                                    </div>
                                    <div class="form-group col-md-6 col-lg-2" id="div_schedule" style="display: none">
                                        ...
                                        <br>
                                        <input type="radio" name="is_schedule" id="is_schedule_yes"
                                            onclick="scheduleRadio(id)" value="yes"><label>Yes</label>
                                        <input type="radio" name="is_schedule" id="is_schedule_no"
                                            onclick="scheduleRadio(id)" value="no"><label>No</label><br>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-lg-2" id="div_transfer_call" style="display: none">
                                        ...
                                        <input type="radio" name="transfer_call"
                                            id="transfer_call_no"><label>No</label><br>
                                    </div>
    ...
    @if ($errors->any())
        <div class="alert_moduurn alert-danger">
            <ul>
