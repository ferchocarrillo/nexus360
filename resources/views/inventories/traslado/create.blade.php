    ...
    {{--end modal--}}
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                {{ Form::label('fTraslado', 'Fecha de Traslado') }}
                                <input type="date" class="form-control" placeholder="" name="fTraslado" id="fTraslado" aria-label="fTraslado" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                {{Form::label('bodegaActual','Bodega Actual')}}
                                <select name="bodegaActual" class="custom-select"  required>
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                {{Form::label('bodegaDestino','Bodega Destino')}}
                                <select name="bodegaDestino" class="custom-select"  required>
                                <option value selected disabled> -- </option>
                                @foreach($bodegas as $bodega)
                                <option value="{{ $bodega->bodega}}">{{ $bodega->bodega }}</option>
                                @endforeach
