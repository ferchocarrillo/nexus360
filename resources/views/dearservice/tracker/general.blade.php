...
@section('title_postfix', ' | Dear Service Report')
@section('content_header')
<img alt="logo" class="logo" src="\img\Dear Service\dear_service.png" />
<h1 class="title_h1"> Report Dear Service</h1>
<div class="float-right">
    <a href="/dearservice/tracker" class="btn btn-info" type="button" title="return"><i
...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="card_first">
            <div class="card-body">
                <form action="{{ route('dearservice.tracker.reportsGeneralDownload') }}" method="POST">
                    @csrf
