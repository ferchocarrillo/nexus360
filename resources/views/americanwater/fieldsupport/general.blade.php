...
@section('title_postfix', ' | American Water Report Field Support')


@section('content_header')
<img alt="logo" class="logo" src="{{asset('/img/americanWater/american_water_logo.png')}}" />
<h1 class="title_h1"> Report Field Support</h1>
...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="card_first">
            <div class="card-body">
                <form action="{{ route('americanwater.fieldsupport.reportsGeneralDownload') }}" method="POST">
                    @csrf
