...
<h1 class="title_h1"> Report Enercare Bo Tracker</h1>
<div class="float-right">
    <a href="/enercare/botracker" class="btn btn-info" type="button" title="return"><i
...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="card_first">
            <div class="card-body">
                <form action="{{ route('enercare.botracker.reportsGeneralDownload') }}" method="POST">
                    @csrf
