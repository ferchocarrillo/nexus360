                    ...
                    <div class="card col-md-12">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <span class="span_item float-right">{{ $trkEdit->queue_tracker }}</span><br>
                                <label for="">Case</label>
                                <span class="span_item float-right">{{ $trkEdit->case }}</span><br>
                                <label for="">Case Actioned</label>
                                <span class="span_item float-right">{{ $trkEdit->case_actioned }}</span><br>
                                ...
                                <span class="span_item float-right">{{ $trkEdit->modified }}</span><br>
                                <label for="">Call Centre</label>
                                <span class="span_item float-right">{{ $trkEdit->call_centre }}</span><br>
                                <label for="">Time Elapsed Since Creation</label>
                                <span class="span_item float-right">{{ $elapsed }}</span><br>
