...
@section('title_postfix', ' | Control de Novedades Reporte Novedades RRHH')
...
<h1 class="d-inline">Reporte Novedades RRHH</h1>
@stop
...
<div class="container">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('payrollnovelty.reports.noveltiesrrhhDownload') }}" method="POST">
                @csrf
