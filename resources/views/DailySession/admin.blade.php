...
@section('title_postfix', ' | Daily Sessions Admin')
...
@section('content_header')
    <h1 class="d-inline">Daily Sessions Admin</h1>
@stop
    ...
    <div class="col-md-6">
        <div class="card shadow">
            <div class="card-header bg-info aling-middle">
                ...
                <button class="btn btn-sm btn-info rounded-circle float-right" data-toggle="modal" data-target="#modalPosition">
   ...
   <script>
       $(document).ready(e=>{
            ...
            function save(){
                ...
                axios.post('/dailysessions/admin/savepositions',{positions})
                .then(res=>{
                    console.log(res);
                })
            }
