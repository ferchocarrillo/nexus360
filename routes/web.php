...
Route::middleware(['auth'])->group(function () {
    ...
    //Enercare Bo Tracker
    Route::get('enercare/botracker/reports/general','EnercareBoTrackerController@general')->name('enercare.botracker.reportsGeneral');
    ...
    Route::get('masterfile/wfh','MasterfileController@wfhIndex')->name('masterfile.wfh.index');
    Route::post('masterfile/wfh','MasterfileController@wfhStore')->name('masterfile.wfh.store');
    Route::post('masterfile/wfh/update','MasterfileController@wfhUpdate')->name('masterfile.wfh.update');
    ...
    Route::post('/prenomina/adjustments/justifyabsence','PrenominaAdjustmentController@justifyAbsence')->name('prenomina.adjustments.justifyabsence');
    ...
    Route::post('/prenomina/admin/saveemailsreportadjustmentspending','PrenominaAdminController@saveEmailsReportAdjustmentsPending')->name('prenomina.admin.saveEmailsReportAdjustmentsPending');
