...
class PayrollNoveltyReportExport implements FromCollection, WithHeadings
{
    ...
    */
    public function collection()
    {
        ...
        ->select('id','supervisor','campaign','full_name','national_id','start_date','end_date','days_hours','contingency as contingency_name','observation')
        ->get();
