...
class EnercareCalltrackerCategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Emergency Plumbing – High Velocity Leak (PB60) [Approved]", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Emergency Plumbing – 1 toilet at home (PB50) [Approved]", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Emergency Plumbing – Main drain Back up (PB25) [Approved]", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Possible Main Drain (PB24)", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Drain Back up (PB27)", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Block Toilet (PB44)", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Dripping Leak Pipe (PB49)", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Toilet Issue (PB90)", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Below Grade Quote (PB91)", "active" => 1]);
        EnercareCalltrackerCategory::create(["category" => "Plumbing", "subcategory" => "Mixing Valve (PBMX)", "active" => 1]);
    }
}
